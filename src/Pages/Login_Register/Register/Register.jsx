...
const Register = () => {
    ...
    return (
        <>
        <Helmet>
            <title>Register | Polling and Survey</title>
        </Helmet>
        <div className="hero min-h-screen bg-base-200 p-2">
            <div className="md:hero-content flex-col p-2">
                <div className="md:text-center lg:text-left">
                    <h1 className="md:text-5xl text-[#854D0E] text-2xl py-3 font-bold">Sign up now!</h1>
                </div>
                <div className="card dark:border-2 shadow-2xl bg-slate-300   md:w-[99%] w-[60%]">
                    ...
                    <p className="ps-5 mb-4 text-lg">Have an account? <span className="text-blue-600 text-xl"> <Link to="/login">Login</Link></span></p>
